...
// copied from https://github.com/golang/build/blob/master/internal/untar/untar.go
...
// ExtractTarball the straighforward way to use untar (wejick)
func ExtractTarball(filePath, dir string) (err error) {
	...
	var tarballReader io.ReadCloser = tarballFile

	err = Untar(tarballReader, dir)
	if err != nil {
		return
	}
